                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <div className="text-gray-400 dark:text-gray-300 text-sm">@chamath</div>
                            </div>
                        </div>
                    ...
                    <div className="flex mt-6 justify-between items-center">
                        <div className="flex space-x-4 text-gray-400 dark:text-gray-300">
                            <div className="flex items-center">
                                ...
                                <span className="ml-2 text-sm text-gray-400">566</span>
                            </div>
                            <div className="flex items-center">
                                <MessageCircleIcon className="h-5 w-5 text-gray-400" />
                                <span className="ml-2 text-sm text-gray-400">241</span>
                            </div>
                            <div className="flex items-center">
                                <RepeatIcon className="h-5 w-5 text-gray-400" />
                                <span className="ml-2 text-sm text-gray-400">487</span>
                            </div>
                        </div>
                        <div className="text-gray-400 dark:text-gray-300 text-sm">7:22 AM · Aug 22, 2023</div>
                    </div>
                </div>
            </div>
        </Card>
